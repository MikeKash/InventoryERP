...
const Sidebar = ({
  ...
  return (
    <aside
      className={twMerge(
        'h-full fixed top-0 left-0 pt-16 border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 ease-in-out duration-100 transition-all',
    ...
    >
      ...
      <div className='hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex  dark:bg-gray-800 z-20'>
        <a
          href='#'
